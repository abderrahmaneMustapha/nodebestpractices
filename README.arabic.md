...
<b> من ناحية اخرى : </b> اسلوب الcallback في Nodejs ,الذي يتمثل في  function(err, response) ,   هو طريقة واعدة لجعل الكود البرمجي غير قابل للصيانة و ذلك يرجع الى مزج معالجة الاخطاء مع الكود , التداخل المفرط , و انماط الكود البرمجي الغريبة.
 : </b> عند استدعاء بعض المكونات ،في حال كنت غيرمتأكد من نوع الأخطاء التي تأتي في المقابل -  هذا سيجعل التعامل المناسب  مع الاخطاء  أكثر صعوبة. والأسوأ من ذلك ، قد يؤدي استخدام أنواع مخصصة لوصف الأخطاء إلى فقدان معلوم

 🔗 [**اقرء المزيد عن افضل الممارسات حول الاعدادات**](/sections/projectstructre/configguide.md) 

 <br/><br/>

 <h2>! [✔] 2.2 استعمال كائن الخطئ المدمج</h2>

**TL;DR:**يقوم العديد بمعالجة الأخطاء كسلسلة (string)  أو كنوع مخصص(custome object)  - وهذا يجعل  معالجة الاخطأ وإمكانية التشغيل البيني بين الوحدات معقدا . فسواء كنت ترفض  promises أو ترطلق استثناءً (throw an exception) أو ترسل خطأً - فإن استخدام كائن خطأ مدمج  (أو كائن يمتد من كائن الخطأ المدمج) سيزيد من التوحيد ويمنع فقدان المعلومات
...
## ![✔] 2.3 افصل بين اخطاء التشغيل و اخطاء المبرمجين

**TL;DR:** اخطاء التشغيل ( عند استقبال الapi لمعلومة خاطئة ) ترجع الى حالات معروفة يكون تاثيرها مفهوما و يمكن التعامل معها بشكل سلس. من جهة اخرى , اخطاء المبرمجين ( مثلا محاولة قراءة من متغير او variable غير معروف undifined) ترجع الى الى حالة غير معروفة و التي تؤدي الى اعادة تشغيل التطبيق من جديد

<b> من ناحية اخرى : </b> من الممكن ان تقوم باعادة تشغيل التطبيق في كل مرة يظهر فيها خطؤما, لكن لمذا تجعل ما يقارب 5000 مستعمل عبر الانترنت ينتضرون  جراء خطئ صغير جدا, يمكن توقعها هذه الاخطاء تتمثل في اخطائ التشغيل, العكس صحيح ايضا - ابقاؤ التطبيق قيد التشغيل في حالة حدوث خطئ غيرمعروف
و الذي يتمثل في  اخطاء المبرمجين مثلا, يمكن ان يؤدي الى حدوث اشياء غير متوقعة, فصل هذان الاثنان سيسمح لك بالتصرف بشكل افضل و ان تقوم بالتعامل مع هذه الاخطاء حسب ما ورد في الفقرة الاخيرة
